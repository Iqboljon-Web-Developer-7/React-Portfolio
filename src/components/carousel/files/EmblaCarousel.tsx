...
const EmblaCarousel: FC<PropType> = ({ images, options }): JSX.Element => {
  ...
  return (
    <div className="embla flex flex-row-reverse md:flex-col gap-4 md:gap-0">
      <div
        className="embla__viewport w-[26rem] lg:w-[34rem]"
        ref={emblaMainRef}
      >
                  ...
                  <>
                    ...
                    <TransformComponent>
                      <img
                        src={img}
                        alt="test"
                        className="embla__slide__number rounded-[0!important] h-[26rem!important] lg:h-[34rem!important] object-contain"
                      />
                    </TransformComponent>
                  </>
                )}
