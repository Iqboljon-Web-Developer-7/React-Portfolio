...
const Services = () => {
  return (
    <section className="services wrapper my-14 px-2 grid sm:grid-cols-2 lg:grid-cols-4 gap-2">
      <div className="service bg-[#F3F5F7] py-12 pl-[14%] pr-[3%] grid gap-2">
        <img src={img1} alt="service car icon" className="max-w-12" />
        <h4 className="text-xl lg:text-[calc(min(.7vw+.7rem,1.5rem))]">
          Free Shipping
        </h4>
        <p className="text-sm text-slate-500">Order above $200</p>
      </div>
      <div className="service bg-[#F3F5F7] py-12 pl-[14%] pr-[3%] grid gap-2">
        ...
        <p className="text-sm text-slate-500">30 days guarantee</p>
      </div>
      <div className="service bg-[#F3F5F7] py-12 pl-[14%] pr-[3%] grid gap-2">
        ...
        <p className="text-sm text-slate-500">Secured by Stripe</p>
      </div>
      <div className="service bg-[#F3F5F7] py-12 pl-[14%] pr-[3%] grid gap-2">
        ...
        <p className="text-sm text-slate-500">Phone and Email support</p>
      </div>
    </section>
  );
};
